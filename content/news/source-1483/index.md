---
title: The 2025 Academic Annual Conference of the Key Laboratory of Intelligent Medical
  Image Computing and the MICS Regional Academic Salon were successfully held in our
  school
date: '2025-11-05T00:00:00+08:00'
summary: On November 3, the "2025 Key Laboratory of Intelligent Medical Image Computing
  Academic Annual Conference and MICS Regional Academic Salon" hosted by Nanjing University
  of Information Science & Technology and jointly organized by the Jiangsu University
  Key Laboratory of Intelligent Medical Image Computing (IMIC Lab)…
type: blog
categories:
- Comprehensive news
tags:
- IMIC
- News·Notifications
source_url: https://imic.nuist.edu.cn/info/1032/1483.htm
...
Jin Zikang fully affirmed the achievements of IMIC laboratory in intelligent pathological diagnosis and treatment, brain science and neuroimaging, multi-modal medical data analysis, etc., and pointed out that intelligent medical image computing is at a critical stage of deep integration of technology and clinical practice. The school will continue to implement the strategy of "artificial intelligence empowers smart health" and rely on innovation platforms such as IMIC laboratories to promote the coordinated development of scientific research innovation and talent training.

This conference aims to strengthen exchanges and cooperation between IMIC laboratories and domestic and foreign academic circles, promote the integration of multidisciplinary intersections and cutting-edge technologies, and promote the innovative development of the laboratory in the fields of medical image computing and smart medical care. Participating experts shared the latest results around medical visual language models, computational pathology, intelligent analysis of cardiovascular images, and artificial intelligence-assisted drug discovery. The content covers cutting-edge directions such as basic medical models, multi-modal stroke diagnosis and treatment, interpretable AI and large image model collaboration.
...
*This page was translated from the [original Chinese source](https://imic.nuist.edu.cn/info/1032/1483.htm).*
